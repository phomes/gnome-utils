...
gdict_source_loader_set_property (GObject      *object,
				  ...
				  GParamSpec   *pspec)
{
  GdictSourceLoader *loader = GDICT_SOURCE_LOADER (object);
  GdictSourceLoaderPrivate *priv = loader->priv;
 ...
 *
 * Returned value: a newly allocated, %NULL terminated array of strings.  You
